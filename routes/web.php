...
Route::get("/hello", function () {	
    ...
    // Route Template Inheritance ของWeek3
...
// Route::get("/product", [StaffController::class, "index"])->name('staff.index');
// Route::get("/product/create", [StaffController::class, "create"])->name('staff.create');
// Route::post("/product", [StaffController::class, "store"])->name('staff.store');
// Route::get('/product/{id}', [StaffController::class, "show"])->name('staff.show');
// Route::get("/product/{id}/edit", [StaffController::class, "edit"])->name('staff.edit');
// Route::patch("/product/{id}", [StaffController::class, "update"])->name('staff.update');
